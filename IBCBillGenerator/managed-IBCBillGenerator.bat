...
set APP_CMDS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=19696 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
cd %APPPATH%
...
java -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=19696 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -cp IBCBillGenerator.jar;"%USERJARS%";"%CLASSPATH%" -Dcom.ibcinc.jdbc-xml-prop-file=props\\dbpool.xml -Dcom.ibcinc.bill-prop-file=props\\properties.props com.ibcinc.applications.RunApp
